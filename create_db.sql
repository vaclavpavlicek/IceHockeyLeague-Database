...
-- Sun 01 Apr 2018 10:41:36 PM CEST
...
-- -----------------------------------------------------
-- Table `extraliga`.`Referees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `extraliga`.`Referees` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `extraliga`.`Players`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `extraliga`.`Players` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `number` SMALLINT NOT NULL,
  `salary` INT NOT NULL,
  `position` ENUM('GOALKEEPER', 'DEFENDER', 'ATTACKER') NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `extraliga`.`RealizationTeam`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `extraliga`.`RealizationTeam` (
  `id` INT NOT NULL AUTO_INCREMENT,
